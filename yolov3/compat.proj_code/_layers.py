...
import time
from _util import bbox_prediction_v2, bbox_prediction
...
def YoloV3_Tiny(size=None, channels=3, anchors=yolo_tiny_anchors,
    ...
    x_8, x = Convolution(name='convolution')(x)

    x = YoloConv(256, name='yolo_conv_0')(x)
    output_0 = YoloOutput(256, len(masks[0]), classes, name='yolo_output_0')(x)

    x = YoloConv(128, name='yolo_conv_1')((x, x_8))
...
def testing(size=None, channels=3, anchors=yolo_tiny_anchors,
    ...
    boxes_0 = tf.keras.layers.Lambda(lambda x: bbox_prediction(x, np.array([(81, 82), (135, 169),  (344, 319)]), classes, size),
                     name='yolo_boxes_0')(output_0)

    boxes_1 = tf.keras.layers.Lambda(lambda x: bbox_prediction(x, np.array([(10, 14), (23, 27), (37, 58)]), classes, size),
                     name='yolo_boxes_1')(output_1)
