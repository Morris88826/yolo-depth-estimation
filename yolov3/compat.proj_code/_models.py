...
def _ConvolutionLayer(Layer):
    def __init__(self, filters, kernel_size, strides=1, batch_norm=True):
        super(_ConvolutionLayer, self).__init__(name="Conv2D")
...
class Yolov3_Tiny(tf.keras.Model):
    def __init__(self, resolution=416):
        ...
        self.conv_0 = _ConvolutionLayer(filters=16, kernel_size=3, strides=1, batch_norm=1)
        self.maxpool_0 = tf.keras.layers.MaxPool2D(pool_size=2, strides=2, padding="SAME", name="MaxPool2D")
        self.conv_1 = _ConvolutionLayer(filters=32, kernel_size=3, strides=1, batch_norm=1)
        self.maxpool_1 = tf.keras.layers.MaxPool2D(pool_size=2, strides=2, padding="SAME", name="MaxPool2D")
        self.conv_2 = _ConvolutionLayer(filters=64, kernel_size=3, strides=1, batch_norm=1)
        self.maxpool_2 = tf.keras.layers.MaxPool2D(pool_size=2, strides=2, padding="SAME", name="MaxPool2D")
        self.conv_3 = _ConvolutionLayer(filters=128, kernel_size=3, strides=1, batch_norm=1)
        self.maxpool_3 = tf.keras.layers.MaxPool2D(pool_size=2, strides=2, padding="SAME", name="MaxPool2D")
        self.conv_4 = _ConvolutionLayer(filters=256, kernel_size=3, strides=1, batch_norm=1)
        self.maxpool_4 = tf.keras.layers.MaxPool2D(pool_size=2, strides=2, padding="SAME", name="MaxPool2D")
        self.conv_5 = _ConvolutionLayer(filters=512, kernel_size=3, strides=1, batch_norm=1)
        self.maxpool_5 = tf.keras.layers.MaxPool2D(pool_size=2, strides=1, padding="SAME", name="MaxPool2D")
        self.conv_6 = _ConvolutionLayer(filters=1024, kernel_size=3, strides=1, batch_norm=1)

        self.conv_7 = _ConvolutionLayer(filters=256, kernel_size=1, strides=1, batch_norm=1)
        self.conv_8 = _ConvolutionLayer(filters=512, kernel_size=3, strides=1, batch_norm=1)
        self.conv_9 = _ConvolutionLayer(filters=255, kernel_size=1, strides=1, batch_norm=0)

        self.conv_10 = _ConvolutionLayer(filters=128, kernel_size=1, strides=1, batch_norm=1)
        self.upsample = tf.keras.layers.UpSampling2D(size=2, name="UpSampling2D")
        self.concat = tf.keras.layers.Concatenate()
        self.conv_11 = _ConvolutionLayer(filters=256, kernel_size=3, strides=1, batch_norm=1)
        self.conv_12 = _ConvolutionLayer(filters=255, kernel_size=1, strides=1, batch_norm=0)
